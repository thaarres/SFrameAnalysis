...
double LumiWeight::getLumiWeight( TString sample ){
  ...
  if( sample.Contains( "TT_TuneCUETP8M2T4"                    ) ) return  831.76      ;//SF
  if( sample.Contains( "TT_TuneEE5C_13TeV-powheg-herwigpp"    ) ) return  831.76      ;
  if (sample.Contains("WJetsToLNu_HT-100To200"                ) ) return 1347*1.21    ;//SF
  if (sample.Contains("WJetsToLNu_HT-200To400"                ) ) return 360*1.21     ;//SF
  if (sample.Contains("WJetsToLNu_HT-400To600"                ) ) return 48.9*1.21    ;//SF
  if (sample.Contains("WJetsToLNu_HT-600To800"                ) ) return 12.08*1.21   ;//SF
  if (sample.Contains("WJetsToLNu_HT-800To1200"               ) ) return 5.26*1.21    ;//SF
